...
| `docs/product-manifesto.md` | Long-form "why Unit": notebook gap, transparent progression, invisible UI | Explaining Unit to team/investors |
| `docs/pricing.md` | Subscription tiers, introductory-offer status, win-back, hard access gate | Changing pricing or paywall scope |
...
| `docs/app-store-submission/final-submit-checklist.md` | v2.1 (build 66) ASC handoff — clean-main provenance gate + screenshot capture runbook | Submitting v2.1 to App Review |

## Agent harness & Claude

| Path | What it is | Use when |
|---|---|---|
| `docs/AGENTS.md` | Rules for AI agents — current release scope, architecture, product model | Read first every session (referenced by CLAUDE.md) |
...
| `docs/archive/geminiresearch-1.md` | Retired periodization research (linear, DUP, block) | Historical context only; not a current product direction |
| `docs/archive/geminiresearch-2.md` | Retired algorithmic progression and 8-week periodization research | Historical context only; do not use to restore the legacy engine |
